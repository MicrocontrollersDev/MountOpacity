...
public class MountOpacityConfig {
    ...
    public static Screen configScreen(Screen parent) {
        return YetAnotherConfigLib.create(CONFIG, ((defaults, config, builder) -> builder
                .title(Text.translatable("key.mount-opacity.mount-opacity"))
                .category(ConfigCategory.createBuilder()
                        .name(Text.translatable("key.mount-opacity.mount-opacity"))
                        .option(Option.createBuilder(float.class)
                                .name(Text.translatable("key.mount-opacity.horse-opacity"))
                                .description(OptionDescription.of(Text.translatable("key.mount-opacity.horse-opacity.description")))
                                ...
                                .build())
                        .option(Option.createBuilder(float.class)
                                .name(Text.translatable("key.mount-opacity.pig-opacity"))
                                .description(OptionDescription.of(Text.translatable("key.mount-opacity.pig-opacity.description")))
                                ...
                                .build())
                        .option(Option.createBuilder(float.class)
                                .name(Text.translatable("key.mount-opacity.strider-opacity"))
                                .description(OptionDescription.of(Text.translatable("key.mount-opacity.strider-opacity.description")))
                                ...
                                .build())
                        .option(Option.createBuilder(float.class)
                                .name(Text.translatable("key.mount-opacity.camel-opacity"))
                                .description(OptionDescription.of(Text.translatable("key.mount-opacity.camel-opacity.description")))
